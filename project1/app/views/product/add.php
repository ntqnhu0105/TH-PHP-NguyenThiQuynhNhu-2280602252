...
<body>
    <div class="container">
        ...
        <div class="card form-card">
            <div class="card-body">
                <form method="post" action="/project1/Product/add" id="addProductForm">
                    <div class="mb-4 position-relative">
                        <label for="name" class="form-label"><i class="fas fa-tag me-2"></i>Tên sản phẩm</label>
                        <input type="text" class="form-control" id="name" name="name" required aria-describedby="nameTooltip">
                    ...
                    <div class="mb-4 position-relative">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="5" required aria-describedby="descTooltip"></textarea>
                        <span class="underline"></span>
                        <i class="fas fa-check-circle validation-icon valid" style="display: none;"></i>
                    ...
                    <div class="mb-4 position-relative">
                        ...
                        <input type="number" class="form-control" id="price" name="price" step="0.01" required aria-describedby="priceTooltip">
                        <span class="underline"></span>
                        <i class="fas fa-check-circle validation-icon valid" style="display: none;"></i>
                        <i class="fas fa-exclamation-circle validation-icon invalid" style="display: none;"></i>
                    ...
                    <div class="d-flex gap-3 flex-wrap">
                        <button type="submit" class="btn btn-primary ripple-btn" aria-label="Thêm sản phẩm">
